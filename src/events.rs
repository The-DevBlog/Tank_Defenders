...
use crate::{resources::Bank, BankBalanceTxt, Barracks, HealthbarBundle, UnitBundle};
...
fn build_unit(
    ...
    unit.destination.0 = Some(Vec3::new(pos.x - 100.0, 1.0, pos.z + 60.0));
